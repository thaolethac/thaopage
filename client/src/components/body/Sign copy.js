...
import { Expo, Power2, Draggable, TweenMax } from "gsap";
      ...
      <div className="Appp">
        <form className="form">
          ...
          <div className="inputGroup inputGroup1">
            ...
            <input className="input" type="email" id="loginEmail" maxlength="254"  />
          ...
          <div className="inputGroup inputGroup2">
            ...
            <input className="input" type="password" id="loginPassword"  />
            
            <label id="showPasswordToggle" for="showPasswordCheck">
              Show
              <input className="input" id="showPasswordCheck" type="checkbox" />
